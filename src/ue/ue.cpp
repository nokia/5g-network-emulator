...
void ue::step()
{
    ...
    phy_h.estimate_channel_estate(TX_DL, phy_s, distance, *mobility_m.get_pos(), get_oldest_timestamp(TX_DL), get_avg_tp(TX_DL), current_t);
    phy_h.estimate_channel_estate(TX_UL, phy_s, distance, *mobility_m.get_pos(), get_oldest_timestamp(TX_UL), get_avg_tp(TX_UL), current_t);
